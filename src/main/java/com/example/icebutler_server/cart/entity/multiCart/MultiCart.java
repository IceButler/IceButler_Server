...
@Getter
@Entity
@SQLDelete(sql = "UPDATE multi_cart SET is_enable = false, update_at = current_timestamp WHERE multi_cart_id = ?")
...
public class MultiCart extends BaseEntity {
  ...
  @OneToOne
  @JoinColumn(name = "multi_fridge_user_id", nullable = false)
